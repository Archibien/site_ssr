export default {
  'construction-maison': {
    ...
    list: [
      ...
      },
      {
        ...
        text: 'Dans le langage architectural, le courant “moderne” fait référence à une période comprise entre 1920 et 2000, où les développements techniques de l’acier, du verre et du béton, associés à un goût pour le minimalisme ont donné lieu à des constructions avec des compositions de volumes sobres. L’adjectif “contemporain” fait référence, lui, aux courants architecturaux actuels. Si vous souhaitez un logement de style moderne ou contemporain avec de grandes ouvertures, une toiture plate, des volumes atypiques et des espaces de vie agréables, l’architecte est le bon professionnel pour vous accompagner.',
        image: {
      ...
      },
      {
        ...
        text: 'Aujourd’hui, de nombreuses techniques de construction permettent d’imaginer des architectures ambitieuses avec des prix et des délais de construction réduits. C’est le cas de la construction modulaire, où des éléments préfabriqués de dimensions standards sont réalisés en usine puis assemblés sur le terrain de la maison. Même si elles sont rares, les maisons réalisées en containers sont très demandées : des containers sont réunis et fixés entre eux pour créer des architectures uniques.',
        image: {
    ...
    listTitle: 'Les différents types de maisons neuves',
    blog: {
    ...
    questions: [
      {
        ...
        answer:
          '<p>De nos jours, les contraintes les plus importantes pour pouvoir construire sur un terrain sont les règles d’urbanisme (Plan Local d’Urbanisme, zone ABF, nature des sols…), et <em> Nom de la plus grosse ville du département </em> et les communes avoisinantes n’échappent pas à la règle. Aussi, concevoir une maison avant de connaître l’endroit où elle sera implantée n’est pas recommandé. Lors de votre recherche de terrain, n’hésitez pas à nous solliciter : Archibien peut vous aider à déterminer le potentiel de constructibilité d’une parcelle.</p>',
      },
      {
    ...
    title_inspiration: [
      'Quelques-uns de nos architectes pour construire votre maison',
      'Quelques maisons construites par nos architectes',
    ],
  },
  'extension-maison': {
    steps: [
    ...
    list: [
      {
        ...
        text: 'Le bois est souvent utilisé pour les projets d’extensions ou d’agrandissement, à juste titre : plus écologique et rapide à construire, il n’y a pas réellement de limitations liées à ce mode constructif. Plusieurs techniques de construction existent et nous pourrons vous aider à déterminer la méthode la plus appropriée : extension en ossature bois préfabriquée ou construite sur place, en panneaux en bois lamellé croisé (CLT), en madriers… Si tous les architectes ne sont pas familiers avec la construction bois, la profession est bien formée et compétente pour gérer des chantiers de construction bois, et nous pourrons vous orienter vers les bonnes agences d’architecture. Certains architectes proposent même d’obtenir des certifications, comme le label PassivHauss (maison passive), HQE, BBC, Effinergie, etc.',
        image: {
    ...
    listTitle: "Les différents types d'extension de maison",
    blog: {
    ...
    title_inspiration: [
      'Quelques-uns de nos architectes pour construire votre extension',
      'Quelques extensions construites par nos architectes',
    ],
  },
  'renovation-maison': {
    steps: [
    ...
    list: [
      ...
      },
      {
        ...
        text: 'La rénovation d’une façade (ou sa modification), l’aménagement d’un jardin, de circulations extérieures ou même d’un carport ou d’un atelier sont tout à fait dans les cordes de certains architectes. Les architectes travaillent aussi à la conception de piscines, de terrasses et d’autres éléments d’agrément.',
        image: {
    ...
    listTitle: 'Les différents projets d’aménagements de maison',
    blog: {
    ...
    questions: [
      {
        ...
        answer:
          '<p>Quel est le prix au mètre carré d’une rénovation ? Quel budget pour un aménagement de maison ? Nous avons souvent à répondre à ces questions. Même si le prix dépend beaucoup du projet et des matériaux mis en oeuvre, il est difficile d’envisager une rénovation pour moins de 1000 € TTC par mètre carré. Cette somme comprend le coût des travaux et les honoraires de l’architecte. Néanmoins, si vous envisagez aussi de faire des modifications structurelles, de changer l’isolation, le système de chauffage ou de remplacer les fenêtres, le budget grimpe rapidement. </p> <p> Il est aussi utile de préciser que le coût moyen d’un projet géré par un architecte est supérieur à celui d’un projet pris en charge par un “simple” maître d’oeuvre, non pas parce que l’architecte est plus cher mais parce que l’architecte travaille en général sur des projets plus complexes que ceux gérés par un maître d’oeuvre. </p>',
      },
      {
        title:
    ...
    title_inspiration: [
      'Quelques-uns de nos architectes pour rénover et aménager votre maison',
      'Quelques rénovations de maisons réalisées par nos architectes',
    ],
  },
  'renovation-appartement': {
    ...
    listTitle: 'Les différents projets d’aménagements d’appartements',
    blog: {
    ...
    title_inspiration: [
      'Quelques-uns de nos architectes pour rénover et aménager votre appartement',
      'Quelques rénovations d’appartements réalisés par nos architectes',
    ],
  },
  'surelevation-maison': {
    steps: [
    ...
    list: [
      ...
      },
      {
        ...
        text: 'Dans le langage architectural, le courant “moderne” fait référence à une période comprise entre 1920 et 2000, où les développements techniques de l’acier, du verre et du béton, associés à un goût pour des formes simples ont donné lieu à des constructions avec des volumes sobres. L’adjectif “contemporain” fait référence, lui, aux courants architecturaux actuels. Si vous souhaitez une surélévation avec de grandes ouvertures, une toiture plate, des volumes atypiques (et bien sûr des espaces de vie agréables), l’architecte est le bon professionnel pour vous accompagner.',
        image: {
    ...
    listTitle: 'Les différents styles de surélévations',
    blog: {
    ...
    questions: [
      {
        ...
        answer:
          '<p>Quel est le prix au mètre carré d’une surélévation faite par un architecte ? Quel budget tout compris pour une surélévation ? Nous avons souvent à répondre à ces questions. Même si le prix dépend beaucoup du projet et des matériaux mis en oeuvre, il est difficile d’envisager une surélévation pour moins de 2400 € TTC par mètre carré chauffé. Cette somme comprend le coût des travaux et les honoraires de l’architecte, mais pas les interventions sur l’existant, qui sont souvent nécessaires. En règle générale, il est recommandé de prévoir un budget supérieur, notamment pour se prémunir des variations de coûts de matériaux et des artisans, qui pèsent énormément sur l’enveloppe totale. </p> <p>Il est aussi utile de préciser que le coût moyen d’un projet géré par un architecte est supérieur à celui d’un projet pris en charge par un “simple” maître d’oeuvre, non pas parce que l’architecte est plus cher mais parce que l’architecte travaille en général sur des projets plus complexes que ceux gérés par un maître d’oeuvre. </p>',
      },
      {
        title: "Comment savoir s'il est possible de faire une surélévation ?",
        answer:
          '<p>Il y a deux grandes contraintes aux projets de réhausse de bâtiments : D’abord les règles d’urbanisme (Plan Local d’Urbanisme, zone ABF, nature des sols…). Mais aussi la façon dont la maison ou le garage existant est construit : pouvoir ajouter un ou plusieurs niveaux et les charges (le poids) correspondant n’est pas automatique. La configuration de la construction existante est aussi déterminante pour savoir si une surélévation peut être réalisée. Prenez contact avec nous pour que nous parlions du projet ! Dans certains cas, une étude de faisabilité peut être nécessaire.</p>',
      },
      {
        title:
    ...
    title_inspiration: [
      'Quelques-uns de nos architectes pour construire votre surélévation',
      'Quelques surélévations de maisons ou de garages réalisés par nos architectes',
    ],
  },
  'surelevation-immeuble': {
    ...
    listTitle: "Les différents styles de surélévations d'immeuble",
    blog: {
      image: 'surelevation-maison-blog.jpg',
    ...
    questions: [
      {
        ...
        answer:
          '<p>Quel est le prix au mètre carré d’une surélévation faite par un architecte ? Quel budget tout compris pour une surélévation ? Nous avons souvent à répondre à ces questions. Même si le prix dépend beaucoup du projet et des matériaux mis en oeuvre, il est difficile d’envisager une surélévation pour moins de 2800 € TTC par mètre carré chauffé. Cette somme comprend le coût des travaux et les honoraires de l’architecte, mais pas les interventions sur l’existant, qui sont souvent nécessaires. En règle générale, il est recommandé de prévoir un budget supérieur, notamment pour se prémunir des variations de coûts de matériaux et des artisans, qui pèsent énormément sur l’enveloppe totale. </p> <p>Il est aussi utile de préciser que le coût moyen d’un projet géré par un architecte est supérieur à celui d’un projet pris en charge par un “simple” maître d’oeuvre, non pas parce que l’architecte est plus cher mais parce que l’architecte travaille en général sur des projets plus complexes que ceux gérés par un maître d’oeuvre. </p>',
      },
      {
        title: "Comment savoir s'il est possible de faire une surélévation ?",
        answer:
          '<p>Il y a trois grandes contraintes aux projets de réhausse de bâtiments : D’abord les règles d’urbanisme (Plan Local d’Urbanisme, zone ABF, nature des sols…). Mais aussi la façon dont l’immeuble existant est construit : pouvoir ajouter un ou plusieurs niveaux et les charges (le poids) correspondant n’est pas automatique. D’autre part, les immeubles sont souvent en copropriété, et l’accord des voisins est indispensable. Enfin, la configuration de la construction existante est aussi déterminante pour savoir si une surélévation peut être réalisée. Prenez contact avec nous pour que nous parlions du projet ! Dans certains cas, une étude de faisabilité peut être nécessaire.</p>',
      },
      {
        title:
          'Est-il nécessaire de travailler avec un architecte pour réaliser une surélévation ?',
    ...
    title_inspiration: [
      'Quelques-uns de nos architectes pour construire votre surélévation d’immeuble',
      'Quelques surélévations d’immeubles réalisés par nos architectes',
    ],
  },
  'construction-immeuble': {
    ...
    list: [
      ...
      },
      {
        ...
        text: 'Un architecte, associé à des bureaux d’études spécialisés, est souvent indispensable dans un projet de construction d’une usine, d’un atelier de fabrication ou de transformation ou de laboratoire ou même de centre logistique. Nos architectes pourront vous accompagner : prenons contact !',
        image: {
    ...
    listTitle: 'Quelques types de bâtiments à construire avec un architecte',
    blog: {
    ...
    questions: [
      {
        ...
        answer:
          '<p>Quel est le prix au mètre carré d’un immeuble construit par un architecte ? Quel budget tout compris pour construire un bâtiment industriel, commercial, d’enseignement ou de soin ? Nous avons souvent à répondre à ces questions. Même si le prix dépend beaucoup du projet et des matériaux mis en oeuvre, il est difficile d’envisager une construction pour moins de 1500 € HT par mètre carré chauffé de bureau. Mais des locaux industriels peuvent avoir des prix qui commencent à quelques centaines d’euros par mètre carré… </p>',
      },
      {
        title: 'Faut-il trouver le terrain avant de commencer à travailler avec un architecte ?',
        answer:
          '<p>De nos jours, les contraintes les plus importantes pour pouvoir construire sur un terrain sont les règles d’urbanisme (Plan Local d’Urbanisme, zone ABF, nature des sols…). Aussi, concevoir un bâtiment avant de connaître l’endroit où il sera implanté n’est pas recommandé. Lors de votre recherche de terrain, n’hésitez pas à nous solliciter : Archibien peut vous aider à déterminer le potentiel de constructibilité d’une parcelle.</p>',
      },
      {
    ...
    title_inspiration: [
      'Quelques-uns de nos architectes pour construire votre bâtiment',
      'Quelques immeubles construits par nos architectes',
    ],
  },
  'renovation-immeuble': {
    steps: [
    ...
    list: [
      ...
      },
      {
        ...
        text: 'Les missions confiées à un architecte ne se cantonnent pas à la configuration des pièces et aux choix des matériaux. Les architectes sont compétents sur les sujets plus techniques : dans le cas de copropriétés en centres anciens par exemple, les architectes entretiennent les copropriétés et supervisent les travaux de ravalement de façade. Consultez-nous pour obtenir un devis pour la gestion d’un ravalement de façade par un ou plusieurs architectes spécialisés.',
        image: {
    ...
    listTitle: 'Les différents types de projets de rénovation de bâtiments',
    blog: {
    ...
    title_inspiration: [
      'Quelques-uns de nos architectes pour des travaux de rénovation d’un bâtiment',
      'Quelques travaux de rénovation réalisés par nos architectes',
    ],
  },
  'amenagement-bureau': {
    steps: [
    ...
    listTitle: 'Les différents types de rénovations de bureaux',
    blog: {
    ...
    title_inspiration: [
      'Quelques-uns de nos architectes pour rénover et aménager des bureaux',
      'Quelques aménagements de bureaux réalisés par nos architectes',
    ],
  },
  'monument-historique': {
    steps: [
      {
        title: '1. Mettre au point votre projet',
        content:
          'À cette étape, il vous faut déterminer dans les grandes lignes : Que voulez-vous faire ? Quelle est votre surface ? Où voulez-vous construire votre maison ? Quel est votre budget ? Le coût de construction d’une maison individuelle sur-mesure commence aux alentours de 1800€ HT par m². Il est donc souvent utile de déterminer un budget en amont et de savoir à quoi les sommes vont être allouées. Vous devez aussi déterminer ce que vous avez le droit de faire : le Plan Local d’Urbanisme et d’autres documents ou interlocuteurs (dont les Architectes des Bâtiments de France, ou “ABF”) encadrent les possibilités de construction. C’est compliqué pour les non-initiés, car les règles sont complexes, et certains éléments doivent être négociés, notamment à 3 plus grosses villes du département. → Archibien vous accompagne pour mettre au point votre projet. Nous avons travaillé sur de nombreux plans de maisons sur des terrains de toutes sortes (étroits, en pente, à découper…), étudié les contraintes d’urbanisme applicables dans des contextes variés (en centre-ville, hameau, au bord de l’eau…), et aidé à la définition d’enveloppes budgétaires.',
      },
      {
        title: '2. Choisir le bon architecte',
        content:
      ...
      },
      {
        title: '4. Détailler le projet et sélectionner les entreprises',
        content:
          'Une fois le Permis de Construire obtenu et affiché pendant le délai légal sans recours de tiers (ou parfois pendant ces délais pour gagner du temps), l’architecte va poursuivre le travail sur le projet, en dessinant plus finement encore la maison : c’est la phase Étude de Projet (PRO), qui permet ensuite de réaliser les plans d’Exécution (EXE). Ces derniers sont utilisés pour obtenir des devis des entreprises qui vont intervenir sur le chantier, et pour pouvoir comparer les offres de ces dernières. Sur la base d’un Dossier de Consultation des Entreprises (DCE), l’architecte a pour rôle d’assister le maître d’ouvrage (le porteur du projet) à passer les contrats : c’est l’Assistance aux Contrats de Travaux (ACT). Toutes ces phases prennent du temps, qu’il ne faut pas négliger : même si les travaux ne peuvent pas commencer avant que le PC ne soit purgé, il est fréquent qu’ils ne commencent que quelques semaines ou mois après ce délai légal, car les bonnes entreprises sont aussi très occupées et doivent organiser leur travail.',
      },
      {
        title: '5. Suivre le chantier et livrer la maison',
        content:
